...
const char * default_beta_peer_network = "le-bunker.ch";
const char * default_live_peer_network = "le-bunker.ch";
const std::string default_test_peer_network = nano::get_env_or_default ("NANO_TEST_PEER_NETWORK", "le-bunker.ch");
}
